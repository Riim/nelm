...
test('multiple element names', () => {
	expect(new Template(`
		#block1
		b/name1, name2
	`).render()).toBe('<b class="block1__name1 block1__name2"></b>');
});
...
test('attributes super', () => {
	...
	expect(t1.extend(`
		#block1-x
		/el1 (super!)
	`).render()).toBe('<b class="block1-x__el1 block1__el1" attr1="value1" attr2="value2"></b>');
});
...
test('attributes super (2)', () => {
	...
	`).render()).toBe('<b class="block1-x__el1 block1__el1" attr1="value0" attr2="value2" attr3="value3"></b>');
});
...
test('class attribute super', () => {
	...
	expect(t1.extend(`
		#block1-x
		/el1 (super!)
	`).render()).toBe('<b class="block1-x__el1 block1__el1 _mod1"></b>');
});
...
test('attributes super super', () => {
	...
	expect(t2.extend(`
		#block1-x-x
		/el1 (super!)
	`).render()).toBe('<b class="block1-x-x__el1 block1-x__el1 block1__el1" attr1="value1" attr2="value2"></b>');
});
